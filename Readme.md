...
- [ ] 📦 [Downloaded latest Arch Linux ISO](https://archlinux.org/download/)
- [ ] 💿 Created bootable USB drive
- [ ] 🔌 Stable internet connection available | ( I use Ethernet but wifi also works )
- [ ] 💾 Backed up important data | ( use dropbox, google drive or any pendrive )
- [ ] ⌨️ Basic Linux command line knowledge | ( not necessary )
- [ ] ⏱️ 2-4 hours of dedicated time | ( patience is most imp. )
...
- **Version**: 3.0.0
- **Maintained by**: [@abyd0w](https://github.com/abyd0w)
